          ...
          >
            <AnimatePresence>
              {hoveredIndex === item.id && (
                ...
                >
                  <div className="absolute inset-x-7 -bottom-px z-30 h-px w-[20%] bg-gradient-to-r from-transparent via-emerald-500 to-transparent" />
                  <div className="absolute -bottom-px left-7 z-30 h-px w-[40%] bg-gradient-to-r from-transparent via-sky-500 to-transparent" />
