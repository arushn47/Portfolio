...
export const Timeline = ({
  ...
  return (
    <div
      ...
      <h2 className="text-lg md:text-5xl font-bold mb-25 text-black dark:text-white max-w-4xl">
        {title}
      </h2>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-1 md:gap-10">
            <div
